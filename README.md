...
2) `/spam <amount> <message>` - повторить фразу message amount раз. Если итоговый текст получится слишком большим,  
он будет разделён на несколько сообщений. Не используйте слишком часто, друзья раы не будут :)
